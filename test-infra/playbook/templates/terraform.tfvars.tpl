...
tectonic_cluster_name = "prom-scale-test"
...
tectonic_metal_controller_domain = "masters.example.com"
...
{{ clientcertfile['content'] | b64decode }}
EOF
...
{{ clientkeyfile['content'] | b64decode }}
EOF
...
tectonic_ssh_authorized_key = "{{ lookup('file', '/root/.ssh/id_rsa.pub') }}"
